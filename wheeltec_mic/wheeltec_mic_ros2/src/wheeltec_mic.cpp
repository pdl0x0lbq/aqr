...
const char* awakename = "/home/coolze/ts_ws1/src/wheeltec_mic/wheeltec_mic_ros2/feedback_voice/awake.wav";
const char* zhixingname = "/home/coolze/ts_ws1/src/wheeltec_mic/wheeltec_mic_ros2/feedback_voice/tts_sample.wav";
...
:rclcpp::Node(node_name){
	...
	sleep(3);
	std::string new_command = std::string("aplay ") + zhixingname;
